...
<!-- Add screenshots here later. Example: ![Stream Dashboard](images/dashboard.png) -->
Technology
...
A .gitignore file is included in the repository to help prevent accidental uploads.
...
It was created because I wanted a better way to monitor my Twitch and YouTube streams from one application.

The project is still evolving as I use it and find things that could be improved.
